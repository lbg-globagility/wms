...
Public Class OutrightPrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Warehouse_Management_System.OutrightPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOutrightPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OutrightPrint = New OutrightPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
