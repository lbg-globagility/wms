...
Public Class AgingReportPrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Warehouse_Management_System.AgingReportPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAgingReportPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AgingReportPrint = New AgingReportPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
