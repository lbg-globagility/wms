...
Public Class ConsignorPrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Warehouse_Management_System.ConsignorPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConsignorPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConsignorPrint = New ConsignorPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
