...
Public Class PullOutAPrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Warehouse_Management_System.PullOutAPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPullOutAPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PullOutAPrint = New PullOutAPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
