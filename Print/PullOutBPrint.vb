...
Public Class PullOutBPrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Warehouse_Management_System.PullOutBPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPullOutBPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PullOutBPrint = New PullOutBPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
