...
Public Class CycleCountReportB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Warehouse_Management_System.CycleCountReportB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCycleCountReportB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CycleCountReportB = New CycleCountReportB()
        rpt.Site = Me.Site
        Return rpt
    End Function
