...
Public Class SellThroughPrintA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Warehouse_Management_System.SellThroughPrintA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSellThroughPrintA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SellThroughPrintA = New SellThroughPrintA()
        rpt.Site = Me.Site
        Return rpt
    End Function
