...
Public Class OutrightPrintE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Warehouse_Management_System.OutrightPrintE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOutrightPrintE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OutrightPrintE = New OutrightPrintE()
        rpt.Site = Me.Site
        Return rpt
    End Function
