...
Public Class VendorReportPrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Warehouse_Management_System.VendorReportPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVendorReportPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VendorReportPrint = New VendorReportPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
