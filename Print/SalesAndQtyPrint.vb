...
Public Class SalesAndQtyPrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Warehouse_Management_System.SalesAndQtyPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSalesAndQtyPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalesAndQtyPrint = New SalesAndQtyPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
