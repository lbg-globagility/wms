...
Public Class StockLevelPrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Warehouse_Management_System.StockLevelPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockLevelPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockLevelPrint = New StockLevelPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
