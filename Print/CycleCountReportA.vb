...
Public Class CycleCountReportA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Warehouse_Management_System.CycleCountReportA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCycleCountReportA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CycleCountReportA = New CycleCountReportA()
        rpt.Site = Me.Site
        Return rpt
    End Function
