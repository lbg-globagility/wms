...
Public Class SellThroughPrintB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Warehouse_Management_System.SellThroughPrintB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSellThroughPrintB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SellThroughPrintB = New SellThroughPrintB()
        rpt.Site = Me.Site
        Return rpt
    End Function
