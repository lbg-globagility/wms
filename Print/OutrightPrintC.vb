...
Public Class OutrightPrintC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Warehouse_Management_System.OutrightPrintC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOutrightPrintC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OutrightPrintC = New OutrightPrintC()
        rpt.Site = Me.Site
        Return rpt
    End Function
