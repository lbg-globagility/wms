...
Public Class CycleCountPrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Warehouse_Management_System.CycleCountPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCycleCountPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CycleCountPrint = New CycleCountPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
