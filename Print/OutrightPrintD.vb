...
Public Class OutrightPrintD
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Warehouse_Management_System.OutrightPrintD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOutrightPrintD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OutrightPrintD = New OutrightPrintD()
        rpt.Site = Me.Site
        Return rpt
    End Function
