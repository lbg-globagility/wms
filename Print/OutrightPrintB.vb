...
Public Class OutrightPrintB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Warehouse_Management_System.OutrightPrintB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOutrightPrintB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OutrightPrintB = New OutrightPrintB()
        rpt.Site = Me.Site
        Return rpt
    End Function
