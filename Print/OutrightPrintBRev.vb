...
Public Class OutrightPrintBRev
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Warehouse_Management_System.OutrightPrintBRev.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOutrightPrintBRev
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OutrightPrintBRev = New OutrightPrintBRev()
        rpt.Site = Me.Site
        Return rpt
    End Function
