...
-- Dumping structure for function dws.M_I_Orders
DELIMITER //
CREATE FUNCTION `M_I_Orders`(`I_OrganizationID` INT(10),
	`I_Created` DATETIME,
	`I_CreatedBy` INT(10),
	`I_LastUpdBy` INT(10),
	`I_AccountID` INT(10),
	...
	`I_ReceivedBy` VARCHAR(100),
	`I_RelatedOrderID` INT(10),
	`I_ContactID` INT(11),
	`I_TimeArrived` TIME,
	`I_ReceivedBrands` VARCHAR(50),
	`I_ContainerNo` VARCHAR(50),
	`I_SealNo` VARCHAR(50),
	`I_ArrivedIn` VARCHAR(50),
