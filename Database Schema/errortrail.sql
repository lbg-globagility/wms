...
DROP TABLE IF EXISTS `errortrail`;
CREATE TABLE IF NOT EXISTS `errortrail` (
  ...
  CONSTRAINT `errortrail_ibfk_1` FOREIGN KEY (`OrganizationID`) REFERENCES `organizations` (`RowID`),
  CONSTRAINT `errortrail_ibfk_2` FOREIGN KEY (`CreatedBy`) REFERENCES `users` (`RowID`),
  CONSTRAINT `errortrail_ibfk_3` FOREIGN KEY (`ViewID`) REFERENCES `views` (`RowID`)
